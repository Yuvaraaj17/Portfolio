        ...
        >
          ...
          >
            <div className="w-full h-full relative">
              ...
              <Link className="hidden w-fit absolute text-white font-ubuntu_mono bottom-0 right-0 text-[10px] items-center md:flex hover:underline underline-offset-2 pr-2 pb-1" href={"https://github.com/Yuvaraaj17/placement"}>{projectDetails[1].name} <IoIosArrowRoundForward size={14}></IoIosArrowRoundForward></Link>
            </div>            
          </div>
          <div
            ref={rightRef}
